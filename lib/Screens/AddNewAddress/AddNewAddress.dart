...
import 'package:food_delivery/Helper/SharedManaged.dart';
      ...
      children: <Widget>[
        new Expanded(
          child: GoogleMap(
            ...
            markers: markers,
            // onCameraMove:(target) => _getAdd(target.target.latitude,target.target.longitude)
          ),
        )
      ],
    );
                              ...
                              child: new InkWell(
                                onTap: () async {
                                  ...
                                  if (status) {
                                    ...
                                    //  Navigator.of(context).pop(true);
                                    SharedManager
                                        .shared.scaffoldKey.currentState
                                        .hideCurrentSnackBar();
