...
class RecentSearchWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Container(
      height: meals.length > 0 ? (meals.length * 160.0) : 0,
      ...
      child:
        ...
        new Row(
          ...
          children: <Widget>[
            setCommonText('Meals', AppColor.black, 18.0, FontWeight.w500, 1),
                              ...
                              child: new Column(
                                ...
                                children: <Widget>[
                                  setCommonText(meals[index].name,
                                      AppColor.black, 16.0, FontWeight.w500, 1),
                                  SizedBox(
                                    height: 3,
                                  ),
                                  setCommonText(meals[index].restaurantName,
                                      AppColor.grey, 14.0, FontWeight.w500, 3),
                                  SizedBox(
                                    height: 5,
                                  ),
                                  new Row(
