...
class PopularRestaurantWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    height:(restaurants.length>0)? MediaQuery.of(context).size.width/2:0,
    // color: AppColor.red,
    ...
    child: new Column(
      ...
      children: <Widget>[
        new Row(
          ...
          children: <Widget>[
            setCommonText('Popular Restaurant', AppColor.black, 18.0, FontWeight.w500, 1),
          ...
          child: new Container(
            child: new ListView.builder(
              ...
              itemBuilder: (context,index){
                return new InkWell(
                  onTap: (){
                    Navigator.of(context,rootNavigator: true).push(MaterialPageRoute(builder: (context)=>BannerDetailsScreen(
                          ...
                          new Expanded(
                            child: new Container(
                              decoration: BoxDecoration(
                                ...
                                borderRadius: new BorderRadius.only(topLeft: Radius.circular(5),topRight: Radius.circular(5))
                              ),
                            ),
                          ),
                          Container(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: <Widget>[
                                    new Text(restaurants[index].name,
                                    style: new TextStyle(
                                      fontSize: 12,
                                    ...
                                    SizedBox(height: 2,),
                                    new Text(restaurants[index].address,
                                    style: new TextStyle(
                                      fontSize: 11,
                                      fontWeight: FontWeight.w500,
                                      color: AppColor.grey
