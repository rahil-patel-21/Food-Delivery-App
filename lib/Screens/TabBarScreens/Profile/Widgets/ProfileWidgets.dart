  ...
  final List listOptions = [
    {
      ...
      "icon": Icon(Icons.lock, color: AppColor.grey[700], size: 20)
    },
    {
      "title": S.current.support,
      "icon": Icon(Icons.headset_mic, color: AppColor.grey[700], size: 20)
    },
    {
      "title": S.current.languages,
      "icon": Icon(Icons.language, color: AppColor.grey[700], size: 20)
    },
    {
      "title": S.current.notifications,
      "icon": Icon(Icons.notifications, color: AppColor.grey[700], size: 20)
    },
    {
      "title": S.current.saved_address,
      "icon": Icon(Icons.note_add, color: AppColor.grey[700], size: 20)
    },
    {
      "title": S.current.logout,
      "icon": Icon(Icons.settings_power, color: AppColor.grey[700], size: 20)
    },
  ];
                    ...
                    builder: (BuildContext context) {
                      ...
                      return AlertDialog(
                        title: setCommonText('${S.current.sureWantToLogout}',
                            AppColor.black, 18.0, FontWeight.w500, 2),
                        ...
                        actions: <Widget>[
                          ...
                          new FlatButton(
                            child: setCommonText('${S.current.cancel}',
                                AppColor.themeColor, 15.0, FontWeight.w500, 2),
                            onPressed: () {
                ...
                children: <Widget>[
                  Row(
                    children: <Widget>[
                      ...
                      setCommonText(
                          email, AppColor.grey[500], 17.0, FontWeight.w400, 1),
                    ],
                  ),
                  SizedBox(
                    height: 8,
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      setCommonText('$mobile', AppColor.grey[500], 17.0,
                          FontWeight.w400, 1),
                    ],
                  ),
                ],
            ...
            children: <Widget>[
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    setCommonText('${Currency.curr}$walletAmount',
                        AppColor.black, 18.0, FontWeight.w500, 1),
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    setCommonText('$totalOrders', AppColor.black, 18.0,
                        FontWeight.w500, 1),
