    ...
    switch (status) {
      case "1":
        return setCommonText(
            '${S.current.pending}', AppColor.black87, 16.0, FontWeight.w500, 1);
      case "2":
        return setCommonText(
            S.current.accept_order, AppColor.black87, 16.0, FontWeight.w500, 1);
      case "3":
        return setCommonText('${S.current.deliveredByRestaurant}', AppColor.red,
            16.0, FontWeight.w500, 1);
      case "4":
        return setCommonText(S.current.preparing_order, AppColor.orange, 16.0,
            FontWeight.w500, 1);
      case "5":
        return setCommonText(S.current.delivered_order, AppColor.themeColor,
            16.0, FontWeight.w500, 1);
      case "6":
        return setCommonText('${S.current.orderPickedUp}', AppColor.black, 16.0,
            FontWeight.w500, 1);
      case "9":
        return setCommonText(
            S.current.canceled_order, AppColor.red, 16.0, FontWeight.w500, 1);
      default:
        return setCommonText('', AppColor.themeColor, 16.0, FontWeight.w400, 1);
    }
  }
}
