        ...
        children: <Widget>[
          new Container(
            ...
            child: new Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                setCommonText(S.current.your_orders, AppColor.themeColor, 18.0,
                    FontWeight.w500, 1),
                Divider(
                  ...
                  child: new Column(
                    children: <Widget>[
                      new Row(
                        children: <Widget>[
                          ...
                          setCommonText(itemList[index].productName,
                              AppColor.black, 15.0, FontWeight.w500, 2),
                        ],
                      ),
                      SizedBox(
                        height: 2,
                      ...
                      setCommonText(itemList[index].description,
                          AppColor.grey[500], 14.0, FontWeight.w400, 2),
                      SizedBox(
                        height: 5,
                      ),
                      new Row(
