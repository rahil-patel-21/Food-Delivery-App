...
class OrderDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Container(
      ...
      child: new Column(
        ...
        children: <Widget>[
          setCommonText(S.current.order_details, AppColor.themeColor, 18.0,
              FontWeight.w500, 1),
          Divider(
            color: AppColor.grey,
          ),
  ...
  _setCommonWidgetForDetails(String title, String value) {
    return new Column(
      ...
      children: <Widget>[
        setCommonText(title, AppColor.grey, 15.0, FontWeight.w500, 1),
        SizedBox(
          height: 1,
        ),
        setCommonText(value, AppColor.black, 14.0, FontWeight.w400, 2),
      ],
    );
  }
