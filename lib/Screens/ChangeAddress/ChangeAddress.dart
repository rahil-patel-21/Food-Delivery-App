      ...
      child: Column(
        children: <Widget>[
          new GestureDetector(
            ...
            child: new Row(
              children: <Widget>[
                new Icon(Icons.add, color: Colors.black, size: 21),
                SizedBox(
                  width: 5,
                ),
      ...
      child: new Container(
        ...
        child: new Column(
          ...
          children: <Widget>[
            ...
            new Row(
              ...
              children: <Widget>[
                setCommonText(_setAddressType(address.addressType),
                    Colors.black, 17.0, FontWeight.w700, 1),
                new IconButton(
                  icon: Icon(
                    Icons.cancel,
                    color: Colors.red,
            ...
            setCommonText(address.name, Colors.grey, 14.0, FontWeight.w500, 1),
            SizedBox(
              height: 3,
            ),
            setCommonText(address.phone, Colors.grey, 14.0, FontWeight.w500, 1),
            SizedBox(
              height: 5,
            ),
            setCommonText(
                address.addressLine1, Colors.grey, 15.0, FontWeight.w500, 2),
            Divider(
              color: Colors.grey,
            )
          ],
