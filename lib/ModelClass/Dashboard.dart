import 'package:food_delivery/BlocClass/CommonBlocClass/BaseMode.dart';
...
//         result: RestaurantLists.fromJson(json["result"]),
//       );
...
//   List<TopRestaurent> topRestaurents;
//   List<BannerRestaurent> popularRestaurents;
//   List<MealDealItems> mealDeal;
...
//       RestaurantLists(
//         bannerRestaurents: List<BannerRestaurent>.from(
//             json["bannerRestaurents"].map((x) => BannerRestaurent.fromJson(x))),
//         topRestaurents: List<TopRestaurent>.from(
//             json["topRestaurents"].map((x) => TopRestaurent.fromJson(x))),
//         popularRestaurents: List<BannerRestaurent>.from(
//             json["popularRestaurents"]
//                 .map((x) => BannerRestaurent.fromJson(x))),
//         mealDeal: List<MealDealItems>.from(
//             json["mealDeal"].map((x) => MealDealItems.fromJson(x))),
//       );

//   Map<String, dynamic> toJson() => {
//         "bannerRestaurents":
//             List<dynamic>.from(bannerRestaurents.map((x) => x.toJson())),
//         "topRestaurents":
//             List<dynamic>.from(topRestaurents.map((x) => x.toJson())),
//         "popularRestaurents":
//             List<dynamic>.from(popularRestaurents.map((x) => x.toJson())),
//         "mealDeal": List<dynamic>.from(mealDeal.map((x) => x.toJson())),
//       };
// }
...
//   factory MealDealItems.fromJson(Map<String, dynamic> json) => MealDealItems(
//         id: json["id"],
//         name: json["name"],
//         resName: json["restaurant_name"],
//         image: json["image"],
...
//   factory BannerRestaurent.fromJson(Map<String, dynamic> json) =>
//       BannerRestaurent(
//         id: json["id"],
//         name: json["name"],
//         image: json["image"],
...
//   TopRestaurent(
//       {this.id, this.image, this.latitude, this.longitude, this.review});

//   factory TopRestaurent.fromJson(Map<String, dynamic> json) => TopRestaurent(
//         id: json["id"],
//         image: json["image"],
//         latitude: json["latitude"],
//         longitude: json["longitude"],
